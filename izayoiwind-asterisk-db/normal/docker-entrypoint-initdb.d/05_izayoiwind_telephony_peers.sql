...
-- 内線番号
INSERT INTO ps_aors (id, max_contacts, remove_existing, qualify_frequency, maximum_expiration, remove_unavailable) VALUES ('310001', @max_contacts, @remove_existing, @qualify_frequency, @maximum_expiration, @remove_unavailable);
INSERT INTO ps_endpoints (id, transport, aors, context, disallow, allow, direct_media, dtmf_mode, force_rport, rewrite_contact, rtp_symmetric, language) VALUES ('310001', 'transport-udp', '310001', 'internal', 'all', 'g726,g722,ulaw,alaw,gsm', 'no', @dtmf_mode, @force_rport, @rewrite_contact, @rtp_symmetric, 'ja');
INSERT INTO ps_globals (id, keep_alive_interval) VALUES ('310001', 100);
